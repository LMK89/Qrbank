...
function renderVietQR(target, payload, options = {}) {
  if (!target) {
...
// src/banks.json
var banks_default = [
  { bin: "970436", code: "VCB", name: "Ng\xE2n h\xE0ng TMCP Ngo\u1EA1i th\u01B0\u01A1ng Vi\u1EC7t Nam", short: "Vietcombank", verified: false },
  { bin: "970407", code: "TCB", name: "Ng\xE2n h\xE0ng TMCP K\u1EF9 th\u01B0\u01A1ng Vi\u1EC7t Nam", short: "Techcombank", verified: false },
  { bin: "970422", code: "MB", name: "Ng\xE2n h\xE0ng TMCP Qu\xE2n \u0111\u1ED9i", short: "MBBank", verified: false },
  { bin: "970416", code: "ACB", name: "Ng\xE2n h\xE0ng TMCP \xC1 Ch\xE2u", short: "ACB", verified: false },
  { bin: "970432", code: "VPB", name: "Ng\xE2n h\xE0ng TMCP Vi\u1EC7t Nam Th\u1ECBnh V\u01B0\u1EE3ng", short: "VPBank", verified: false },
  { bin: "970418", code: "BIDV", name: "Ng\xE2n h\xE0ng TMCP \u0110\u1EA7u t\u01B0 v\xE0 Ph\xE1t tri\u1EC3n Vi\u1EC7t Nam", short: "BIDV", verified: false },
  { bin: "970415", code: "CTG", name: "Ng\xE2n h\xE0ng TMCP C\xF4ng th\u01B0\u01A1ng Vi\u1EC7t Nam", short: "VietinBank", verified: false },
  { bin: "970423", code: "TPB", name: "Ng\xE2n h\xE0ng TMCP Ti\xEAn Phong", short: "TPBank", verified: false },
  { bin: "970403", code: "STB", name: "Ng\xE2n h\xE0ng TMCP S\xE0i G\xF2n Th\u01B0\u01A1ng T\xEDn", short: "Sacombank", verified: false },
  { bin: "970441", code: "VIB", name: "Ng\xE2n h\xE0ng TMCP Qu\u1ED1c t\u1EBF Vi\u1EC7t Nam", short: "VIB", verified: false },
  { bin: "970443", code: "SHB", name: "Ng\xE2n h\xE0ng TMCP S\xE0i G\xF2n - H\xE0 N\u1ED9i", short: "SHB", verified: false },
  { bin: "970437", code: "HDB", name: "Ng\xE2n h\xE0ng TMCP Ph\xE1t tri\u1EC3n Th\xE0nh ph\u1ED1 H\u1ED3 Ch\xED Minh", short: "HDBank", verified: false },
  { bin: "970426", code: "MSB", name: "Ng\xE2n h\xE0ng TMCP H\xE0ng H\u1EA3i Vi\u1EC7t Nam", short: "MSB", verified: false },
  { bin: "970448", code: "OCB", name: "Ng\xE2n h\xE0ng TMCP Ph\u01B0\u01A1ng \u0110\xF4ng", short: "OCB", verified: false },
  { bin: "970440", code: "SeABank", name: "Ng\xE2n h\xE0ng TMCP \u0110\xF4ng Nam \xC1", short: "SeABank", verified: false },
  { bin: "970431", code: "EIB", name: "Ng\xE2n h\xE0ng TMCP Xu\u1EA5t Nh\u1EADp kh\u1EA9u Vi\u1EC7t Nam", short: "Eximbank", verified: false },
  { bin: "970428", code: "NAB", name: "Ng\xE2n h\xE0ng TMCP Nam \xC1", short: "Nam A Bank", verified: false },
  { bin: "970454", code: "BVB", name: "Ng\xE2n h\xE0ng TMCP B\u1EA3n Vi\u1EC7t", short: "BVBank", verified: false },
  { bin: "970405", code: "VARB", name: "Ng\xE2n h\xE0ng N\xF4ng nghi\u1EC7p v\xE0 Ph\xE1t tri\u1EC3n N\xF4ng th\xF4n Vi\u1EC7t Nam", short: "Agribank", verified: false },
  { bin: "546034", code: "CAKE", name: "Ng\xE2n h\xE0ng TMCP Vi\u1EC7t Nam Th\u1ECBnh V\u01B0\u1EE3ng - Ng\xE2n h\xE0ng s\u1ED1 Cake by VPBank", short: "Cake", verified: false },
  { bin: "970424", code: "SHBVN", name: "Ng\xE2n h\xE0ng TNHH MTV Shinhan Vi\u1EC7t Nam", short: "Shinhan Bank", verified: false },
  { bin: "963388", code: "TIMO", name: "Ng\xE2n h\xE0ng TMCP B\u1EA3n Vi\u1EC7t - Ng\xE2n h\xE0ng s\u1ED1 Timo", short: "Timo", verified: false }
];

// src/index.js
var banks = banks_default;
...
var FONT = "'Archivo', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif";
var COLOR = {
  text: "#201e1d",
  accent: "#ec3013",
  white: "#ffffff",
...
var measureCtx = typeof document !== "undefined" ? document.createElement("canvas").getContext("2d") : null;
...
function generateVietQRCard(payload, templateId = "minimal", data = {}) {
  ...
  const fallbackIdentity = [bankName, maskAccountNo(data.accountNo)].filter(Boolean).join(" ") || data.accountNo || "";
  ...
  if (templateId === "boarding-pass") {
    ...
    drawField(pad, ly, "Ng\xE2n h\xE0ng", bankName);
    drawField(pad + colW + colGap, ly, "S\u1ED1 t\xE0i kho\u1EA3n", data.accountNo);
    ly += 44;
    drawField(pad, ly, "Ch\u1EE7 t\xE0i kho\u1EA3n", holder);
    if (data.purpose) {
    ...
    body += text("Qu\xE9t \u0111\u1EC3 tr\u1EA3", leftW + rightW / 2, cardHeight - 16, { size: 11, spacing: "0.1em", upper: true, anchor: "middle", color: COLOR.neutral600 });
    const background = `<g filter="url(#sh)"><rect x="0" y="0" width="${cardWidth}" height="${cardHeight}" fill="${COLOR.white}"/></g>`;
    return wrap(cardWidth, cardHeight, shadowFilter("sh", 3, 5, 0.16), background, body);
  }
  if (templateId === "receipt") {
    ...
    body += text("Y\xEAu c\u1EA7u thanh to\xE1n", pad, 30, { size: 11, spacing: "0.18em", upper: true, color: COLOR.white });
    ...
    if (bankName) row("Ng\xE2n h\xE0ng", bankName);
    if (data.accountNo) row("S\u1ED1 t\xE0i kho\u1EA3n", data.accountNo);
    if (data.purpose) {
  ...
  if (templateId === "poster") {
    ...
    let body = "";
    const headerH = 118;
    body += text("Qu\xE9t \u2014 chuy\u1EC3n \u2014 xong", pad, 44, { size: 11, spacing: "0.2em", upper: true, color: COLOR.white });
    body += text(amountStr || "QU\xC9T M\xC3", pad, 90, { size: 42, weight: 700, color: COLOR.white, maxWidth: cardWidth - pad * 2 });
    let y = headerH;
    const contentW = cardWidth - pad * 2;
    const qrBoxPad = 26;
    const qrDisplaySize = contentW - qrBoxPad * 2;
    ...
    cell(0, 0, "Ng\xE2n h\xE0ng", bankName);
    cell(1, 0, "S\u1ED1 t\xE0i kho\u1EA3n", data.accountNo);
    cell(0, 1, "Ch\u1EE7 t\xE0i kho\u1EA3n", holder);
